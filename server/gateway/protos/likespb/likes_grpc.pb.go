...
const (
	LikeService_Like_FullMethodName     = "/likes.LikeService/Like"
	LikeService_GetLikes_FullMethodName = "/likes.LikeService/GetLikes"
)
...
func (c *likeServiceClient) GetLikes(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*LikesResponse, error) {
	...
	err := c.cc.Invoke(ctx, LikeService_GetLikes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
